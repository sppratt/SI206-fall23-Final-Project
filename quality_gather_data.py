...
def add_quality_data(cur, conn, some_list):
    ...
    # get count to keep track of what number youre on
    # want to access size to size +25
    for city in some_list[25:50]:
        country = city[2]
...
def main():
    ...
    quality_list = quality_gather_data(url, cur, conn)
    ...
    # weather_list = weather_gather_data(pop_list)
    ...
    add_countries(cur, conn, pop_list, quality_list)
